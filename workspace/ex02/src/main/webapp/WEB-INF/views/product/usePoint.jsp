...
<body>
	<form action="/use" method="post">
		...
		<table border="1" style="margin: 0 auto;">
			...
			<tr>
				<td><input type="radio" name="productNumber" value="1">
				</td>
				<td>오징어 땅콩</td>
				<td>3500</td>
			</tr>
			<tr>
				<td><input type="radio" name="productNumber" value="2">
				</td>
				<td>초코 우유</td>
				<td>1500</td>
			</tr>
			<tr>
				<td><input type="radio" name="productNumber" value="3">
				</td>
				<td>벌꿀 피자</td>
				<td>2800</td>
			</tr>
			<tr>
				<td><input type="radio" name="productNumber" value="4">
				</td>
				<td>샌드위치</td>
				<td>4500</td>
			</tr>
		...
		<div style="text-align: center;">
			<input type="text" name="point" placeholder="사용하실 포인트를 입력하세요."
				style="width: 200px;" /> <input type="submit" value="구매" />
		</div>
		<br>
	</form>
