...
public class BoardControllerTests {
	...
	public void listTest() throws Exception{
		log.info(mockMvc.perform(MockMvcRequestBuilders.get("/board/list").param("pageNum", "205").param("amount", "10")).andReturn().getModelAndView().getModelMap());
	}
...
//		mockMvc.perform(MockMvcRequestBuilders.get("/board/modify").param("bno", "10"));
//	}
